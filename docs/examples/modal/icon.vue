<template>
  <div class="flex w-full justify-between gap-x-5">
    ...
    <button class="li-btn li-btn-primary" @click="handleOpenModal1">该modal有关闭图标</button>
    ...
    <button class="li-btn li-btn-primary" @click="handleOpenModal2">该modal无关闭图标</button>
  </div>
</template>
